...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(255, 240, 207);")
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(0, 0, 741, 271))
        ...
        self.salineInput.setGeometry(QtCore.QRect(140, 30, 201, 21))
        self.salineInput.setStyleSheet("background-color: rgb(229, 226, 255);")
        self.salineInput.setObjectName("salineInput")
        self.label_4 = QtWidgets.QLabel(self.page)
        self.label_4.setGeometry(QtCore.QRect(60, 30, 60, 16))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.page)
        self.label_5.setGeometry(QtCore.QRect(60, 60, 60, 16))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.page)
        self.label_6.setGeometry(QtCore.QRect(60, 90, 60, 16))
        self.label_6.setObjectName("label_6")
        self.mixedInput = QtWidgets.QPlainTextEdit(self.page)
        self.mixedInput.setGeometry(QtCore.QRect(140, 60, 201, 21))
        ...
        self.amountCInput.setGeometry(QtCore.QRect(140, 90, 201, 21))
        ...
        self.percentMInput.setGeometry(QtCore.QRect(140, 180, 201, 21))
        ...
        self.label_9.setGeometry(QtCore.QRect(60, 180, 60, 16))
        ...
        self.label_10.setGeometry(QtCore.QRect(50, 210, 60, 16))
        self.label_10.setObjectName("label_10")
        self.flowRateInput = QtWidgets.QPlainTextEdit(self.page)
        self.flowRateInput.setGeometry(QtCore.QRect(140, 210, 201, 21))
        ...
        self.label_11.setGeometry(QtCore.QRect(50, 240, 60, 16))
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self.page)
        self.label_12.setGeometry(QtCore.QRect(410, 10, 81, 16))
        self.label_12.setObjectName("label_12")
        self.gaugeType = QtWidgets.QComboBox(self.page)
        self.gaugeType.setGeometry(QtCore.QRect(490, 10, 191, 21))
        self.gaugeType.setObjectName("gaugeType")
        self.gaugeType.addItem("")
        self.gaugeType.addItem("")
        self.gaugeType.addItem("")
        self.gaugeType.addItem("")
        self.gaugeType.addItem("")
        ...
        self.comboBox.setGeometry(QtCore.QRect(140, 236, 201, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(_translate("MainWindow", "Gauge Type:"))
        self.gaugeType.setItemText(0, _translate("MainWindow", "Gauge23"))
        self.gaugeType.setItemText(1, _translate("MainWindow", "Gauge18"))
        self.gaugeType.setItemText(2, _translate("MainWindow", "Gauge16"))
        self.gaugeType.setItemText(3, _translate("MainWindow", "Gauge20"))
        self.gaugeType.setItemText(4, _translate("MainWindow", "Gauge24"))
        self.gaugeType.setItemText(5, _translate("MainWindow", "Gauge22"))
        self.comboBox.setItemText(0, _translate("MainWindow", "RightFoot"))
        self.comboBox.setItemText(1, _translate("MainWindow", "LeftAntecubital"))
        self.comboBox.setItemText(2, _translate("MainWindow", "RightWrist"))
        self.comboBox.setItemText(3, _translate("MainWindow", "RightHand"))
        self.comboBox.setItemText(4, _translate("MainWindow", "LeftForearm"))
        self.comboBox.setItemText(5, _translate("MainWindow", "LeftHand"))
        self.comboBox.setItemText(6, _translate("MainWindow", "RightAntecubital"))
        self.comboBox.setItemText(7, _translate("MainWindow", "LeftFoot"))
        self.comboBox.setItemText(8, _translate("MainWindow", "LeftWrist"))
        self.comboBox.setItemText(9, _translate("MainWindow", "RightForearm"))
